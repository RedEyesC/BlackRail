...
using TypeIndex = MotionMatching.Binary.TypeIndex;
...
namespace MotionMatching
{
    ...
    public struct QueryMarkerExpression : IDisposable
    {
        ...
        struct Constraint
        {
            ...
            {
                return new Constraint { typeIndex = typeIndex, type = type };
            }
        }
        ...
        public QueryMarkerExpression At<T>()
            where T : struct
        {
            constraints.Add(Constraint.Create(GetTypeIndex<T>(), Type.At));
        ...
        public QueryMarkerExpression Before<T>()
            where T : struct
        {
            constraints.Add(Constraint.Create(GetTypeIndex<T>(), Type.Before));
        ...
        public QueryMarkerExpression After<T>()
            where T : struct
        {
            constraints.Add(Constraint.Create(GetTypeIndex<T>(), Type.After));
        ...
        QueryResult Execute()
        {
            ...
            {
                ApplyConstraints(ref queryResult.sequences.At(i));
            }
        ...
        void Before(ref PoseSequence sequence, TypeIndex typeIndex)
        {
            ...
            //ref var interval = ref binary.GetInterval(sequence.intervalIndex);
            ...
            //        {
            //            var markerType = binary.GetTrait(marker.traitIndex).typeIndex;
