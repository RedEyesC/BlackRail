                        ...
                        case 2:
                            ...
                            for (int j = 0; j < nverts; j++)
                            {
                                ...
                                Vector3 v1 = new Vector3(
                                    parameterList[vertIndex + j * 3],
                                    parameterList[vertIndex + j * 3 + 1],
                                    parameterList[vertIndex + j * 3 + 2]
                                );
                                Vector3 v2 = new Vector3(
                                    parameterList[vertIndex + j1 * 3],
                                    parameterList[vertIndex + j1 * 3 + 1],
                                    parameterList[vertIndex + j1 * 3 + 2]
                                );
